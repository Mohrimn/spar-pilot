...
export function inferOfferCategory({ productName = "", brandName = "", description = "", unitShort = "" }) {
  ...
  if (has(["tiefgekuhlt", "tiefkuehl", "pizza", "pommes", "frites", "eis", "tk", "piccolinis", "frosta", "bami", "burgerpatty", "burgerpatties", "veggieburger", "cheeseburger", "chickenburger"])) return "Tiefkuhlkost";
  ...
  if (has(["joghurt", "skyr", "quark", "milch", "mozzarella", "kase", "kaese", "schnittkase", "weichkase", "hartkase", "frischkase", "huttenkase", "ricotta", "butter", "sahne", "cremiot", "muritzer", "mueritzer", "activia", "almighurt", "monte", "finello", "grana", "padano", "brie", "camembert", "vioblock", "violife", "streich", "ehrmann"])) return "Molkerei & Kaese";
  if (has(["bier", "helles", "pils", "weizen", "wein", "sekt", "prosecco", "whisky", "vodka", "rum", "likor", "likoer", "cola", "limonade", "saft", "wasser", "shot", "espresso", "kaffee", "spritz", "aperitivo", "tee", "halswarmer"])) return "Getranke";
  ...
  if (has(["apfel", "pflaume", "mandarine", "zitrone", "birne", "orange", "trauben", "banane", "heidelbeere", "gemuse", "kartoffel", "karotte", "karott", "brokkoli", "tomat", "ingwer", "rote", "obst", "salat", "kohlrabi", "kohl", "zwiebel", "mango", "physalis", "spinat", "sellerie", "knoblauch", "melon"])) return "Obst & Gemuese";
  if (has(["chips", "cracker", "waffel", "keks", "schokolade", "bonbon", "gumm", "riegel", "nuss", "musli", "muesli", "cerealien", "honig", "kitkat", "celebrations", "ovomaltine", "studentenfutter", "haferkissen", "crunchy", "pinienkerne", "walnuss", "crisps"])) return "Snacks & Susses";
...
export const ANGEBOTE_SYNONYMS = {
  bier: ["helles", "pils", "pilsener", "weizen", "weissbier", "lager", "craftbier", "radler"],
  helles: ["bier", "pils", "lager"],
  pils: ["bier", "helles", "pilsener"],
  weizen: ["bier", "weissbier"],
  wasser: ["mineralwasser", "sprudel", "still", "tafelwasser"],
  cola: ["limonade", "softdrink", "coca", "pepsi", "original taste"],
  kaffee: ["kaffeebohnen", "bohnenkaffee", "espresso", "filterkaffee"],
  milch: ["vollmilch", "h-milch", "frischmilch", "haltbare milch"],
  butter: ["markenbutter", "rahmbutter", "streichzart", "laetta"],
  kase: ["kaese", "schnittkase", "weichkase", "hartkase", "frischkase", "reibekase", "gouda", "emmentaler", "edamer", "camembert", "brie", "mozzarella", "parmesan", "grana", "padano", "butterkase", "huttenkase", "muritzer", "mueritzer", "cremiot", "old amsterdam", "bergkase", "wildblumenkase"],
  kaese: ["kase", "schnittkase", "weichkase", "hartkase", "frischkase", "reibekase", "gouda", "emmentaler", "edamer", "camembert", "brie", "mozzarella", "parmesan", "grana", "padano", "butterkase", "huttenkase", "muritzer", "mueritzer", "cremiot", "old amsterdam", "bergkase", "wildblumenkase"],
  fleisch: ["rind", "schwein", "pute", "hahnchen", "hackfleisch", "steak", "braten", "schnitzel", "wurst"],
  wurst: ["aufschnitt", "salami", "schinken", "mortadella", "bratwurst"],
  fisch: ["lachs", "forelle", "kabeljau", "rotbarsch", "garnelen", "garnele", "seelachs"],
  joghurt: ["joghurt", "skyr", "quark"],
  jogurt: ["joghurt", "skyr", "quark"],
  musli: ["muesli", "cerealien", "crunchy"],
  muesli: ["musli", "cerealien", "crunchy"],
  crispy: ["crisps", "chips", "cracker"],
  crisps: ["chips", "cracker", "snack"],
  tofu: ["raeuchertofu", "vegan", "pflanzlich"],
};

export const EXPANSIONS = {
  "milch": 'milch OR vollmilch OR "h-milch"',
  "butter": 'butter OR "irische butter" OR markenbutter',
  "kaffee": 'kaffee OR kaffeebohnen',
  "bier": 'bier OR pils OR weizen',
  "wasser": 'wasser OR mineralwasser',
};
...
function buildTokenCandidates(token) {
  ...
  [normalized, ...synonym].forEach(t => addInflectionVariants(t, inflection));
...
function tokenMatchesCandidate(offerToken, candidate) {
  ...
  return offerToken.startsWith(candidate) || offerToken.endsWith(candidate);
}
...
export function highlightTitle(title, query) {
  ...
  const candidates = tokenizeNormalized(q).flatMap(expandQueryToken);
  if (!candidates.length) return { parts: [title], hasHighlight: false };
  const escaped = candidates.filter(c=>c.length>=2).map(c=>c.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"));
  if (!escaped.length) return { parts: [title], hasHighlight: false };
